...
int main(void) 
{
        int i, nx, ny, nz, gridgap = 5, minclus = 1, totalKs, *Ks, 
	    maxclus = 50;
	double *bic, *sigma, *icl, *sd_sigma, *sd_q, *X, *ests, *pvals, y;
	...
	/*	fout = fopen("breast.sds", "w");*/
	fout = fopen("T1-weighted.sds", "w");
