/* array.h
   ...
   o This file defines the following macros:
     ...
     MAKE_2RAGGEDARRAY(a,m,dim)  make a 2D ragged array of m rows of 
                                 variable row length given by dim
     ...
     FREE_2RAGGEDARRAY(a)        free memory allocated by MAKE_2RAGGEDARRAY()
...
---- END OF SAMPLE USAGE -------
   ...
   Revised Apr 2007 - added macro for two-dimensional ragged arrays */
...
#define MAKE_2RAGGEDARRAY(a, m, n) do {                                      \
   size_t ARRAY_H2RESERVED;						     \
   MAKE_1ARRAY(a, (m) + 1 );                                                 \
   if (a == NULL)							     \
     break;								     \
   (a)[m] = NULL;							     \
   for (ARRAY_H2RESERVED = 0; ARRAY_H2RESERVED < (m); ARRAY_H2RESERVED++ ) { \
      MAKE_1ARRAY( (a)[ARRAY_H2RESERVED], *(n + ARRAY_H2RESERVED));	     \
    /* This is the only change with MAKE_2ARRAY */			     \
   if ((a)[ARRAY_H2RESERVED] == NULL) {					     \
      FREE_2RAGGEDARRAY( a );						     \
      break;                                                                 \
    }                                                                        \
...
#define FREE_2RAGGEDARRAY(a)   FREE_2ARRAY(a)
